        ...
        <div className="flex flex-col lg:flex-row lg:justify-between">
          ...
          <div className="lg:w-3/5">
            ...
            <p className="mt-4 text-base">
              ...
              guitar. My favourite musicians include Peter Cat
              <Image className="inline m-0" src={dp} alt="dp" height={25} />
            </p>
          </div>
        </div>
      </section>
