...
export const projects: Project[] = [
  {
    title: "Investigating Racial Disparities in NYPD Stop-and-Frisk Practices : A Multi-Stage Analysis using Predictive Modeling, Statistical Metrics, and Causal Inference",
    preview: "https://github.com/dhruvgupta3126/diss.git",
    description: "A comprehensive analysis of NYPD stop-and-frisk data (2017–2024) using machine learning, fairness metrics, and causal inference reveals significant racial disparities, with race shown to be a key causal factor in frisk decisions..",
    image: schoolseeker,
    tools: ["Python", "XGBoost (Gradient Boosted Trees)", "Random Forest", "Logistic Regression", "Logistic Regression with Cross-Validation", "Fairness Metrics", "Causal Inference", "Shapley Values", "Matplotlib", "Seaborn", "Pandas", "NumPy"],
  },
  {
